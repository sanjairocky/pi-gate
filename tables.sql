CREATE TABLE store (
id INTEGER(999) PRIMARY KEY AUTOINCREMENT NOT NULL,
name TEXT
(30) NOT NULL UNIQUE,
description TEXT
(100) NOT NULL,
...
CREATE TABLE user (
id INTEGER(9999) PRIMARY KEY AUTOINCREMENT NOT NULL,
name TEXT
(30) NOT NULL UNIQUE,
mobile TEXT
(10) NOT NULL UNIQUE);
...
FOREIGN KEY
    ...
    CREATE TABLE store_user_transaction
    (
        store_id INTEGER(999) NOT NULL,
        user_id INTEGER(9999) NOT NULL,
    ...
    CREATE TABLE store_transaction_type
    (
        id INTEGER(9) PRIMARY KEY NOT NULL,
...
id INTEGER(99999) PRIMARY KEY AUTOINCREMENT NOT NULL,
address TEXT
    (120) NOT NULL,
description TEXT
    (50),
